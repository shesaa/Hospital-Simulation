...
SECTION_CAPACITIES: Dict[SectionType, Capacity] = {
    ...
    SectionType.PRE_SURGERY: Capacity(servers=35, queue=None),
    SectionType.EMERGENCY: Capacity(servers=10, queue=10),
    SectionType.LABRATORY: Capacity(servers=3, queue=None),
    SectionType.OPERATING_ROOMS: Capacity(servers=40, queue=None),
    SectionType.WARD: Capacity(servers=60, queue=None),
